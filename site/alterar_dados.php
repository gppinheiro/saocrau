...
<html lang="pt">
    <head>
        ...
        <title>CSCD São Clãudio - Alterar Dados</title>
    </head>
    <body>
        <!--Navbar-->
        ...
        <section>
            <div class="container">
                <div class="row">
                    <form class="col-lg-4 col-md-6 col-sm-12 customform" action="./php/alterar.php" method="post">
                        <h2 class="mb-3">Alterar Dados</h2>
